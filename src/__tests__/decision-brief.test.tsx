...
describe("DecisionPackageView executive memo", () => {
  it("renders the Prepared by Compass masthead and memo sections", () => {
    ...
    expect(screen.getByText("Impact at a glance")).toBeTruthy();
    expect(screen.getByText("Why this decision, why now")).toBeTruthy();
    ...
    expect(screen.getByText("Evidence & comparable implementations")).toBeTruthy();
    expect(screen.getByText("Measurement & learning")).toBeTruthy();
