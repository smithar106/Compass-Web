...
export function DecisionDetail({ decision }: { decision: DemoDecision }) {
  return (
    <div>
      ...
      <div className="mt-6 border border-line bg-paper px-5 py-5 sm:px-6">
      ...
      <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Fact label="Owner" value={decision.owner} />
        <Fact label="Next action" value={decision.nextAction} />
        <Fact label="Confidence" value={decision.confidence} />
        <Fact label="Projected ROI" value={decision.roi} />
