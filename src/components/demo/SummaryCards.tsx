  ...
  return (
    <section aria-label="Decision summary">
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-5">
        <div className="relative overflow-hidden border border-line bg-surface px-6 py-7">
          <div aria-hidden="true" className="absolute left-0 top-0 h-1 w-full" style={{ backgroundColor: C.gold }} />
        ...
        <div className="relative overflow-hidden border border-line bg-surface px-6 py-7">
          <div aria-hidden="true" className="absolute left-0 top-0 h-1 w-full" style={{ backgroundColor: C.teal }} />
          <p className="text-[clamp(3rem,5vw,4rem)] font-extralight leading-none tracking-[-0.03em] text-ink">
        ...
        <div className="relative overflow-hidden border border-line bg-surface px-6 py-7">
          <div aria-hidden="true" className="absolute left-0 top-0 h-1 w-full" style={{ backgroundColor: C.purple }} />
          <p className="text-[clamp(3rem,5vw,4rem)] font-extralight leading-none tracking-[-0.03em] text-ink">
            {demoSummary.completedMeasured}
          </p>
          <p className="mt-3 text-[14px] font-semibold text-ink">Outcomes measured</p>
        </div>
        <div className="relative overflow-hidden border border-[#cfe6d8] bg-[#f2faf5] px-6 py-7 lg:col-span-1">
