    ...
    <div className="space-y-12">
      ...
      <section aria-label="Quick actions" className="flex flex-wrap items-center gap-3">
        ...
        <Link
          ...
          className={cn(
            "inline-flex items-center gap-2 border border-line bg-surface px-5 py-2.5 text-[13.5px] font-semibold transition-colors",
        ...
        <Link
          href="/demo"
          className="inline-flex items-center gap-2 border border-line bg-surface px-5 py-2.5 text-[13.5px] font-semibold text-ink transition-colors hover:border-ink"
        >
          View demo
        </Link>
      </section>
      ...
      {loading ? (
        ...
        >
          ...
          <Link
            href="/assessment"
            className="mt-8 inline-flex items-center gap-2 bg-ink px-6 py-3 text-[14px] font-semibold text-paper transition-colors hover:bg-ink2"
          >
            Start Assessment
        ...
        <>
          ...
          <section aria-label="Filters" className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <select
                ...
                className="border border-line bg-surface px-3 py-1.5 text-[13px] text-ink focus:border-ink focus:outline-none"
              >
              ...
              <input
                ...
                className="w-full max-w-xs border border-line bg-surface px-3 py-1.5 text-[13px] text-ink placeholder:text-faint focus:border-ink focus:outline-none"
              />
              ...
              {(statusFilter !== "all" || functionFilter !== "all" || search) && (
                <button
                  ...
                  className="text-[12.5px] font-medium text-muted underline decoration-line underline-offset-4 transition-colors hover:text-ink"
                >
                  Clear filters
                </button>
              )}
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
            {/* Recent activity — derived only from real registry entries */}
              ...
              {rows.length === 0 ? (
                <div className="border border-line bg-surface px-5 py-8 text-center">
                  <p className="text-[13px] leading-relaxed text-muted">
                    Activity will appear here as decisions move through review, approval, and
                    implementation.
                  </p>
                </div>
              ) : (
                  ...
                  {rows.slice(0, 6).map((r) => (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <Link href={`/decisions/${r.id}`} className="mt-0.5 block text-[13.5px] font-medium text-ink hover:underline">
                          {r.title}
                        </Link>
            ...
            {/* Coverage summary — from the existing coverage API */}
